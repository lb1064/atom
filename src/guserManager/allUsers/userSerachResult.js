...
new (function(){
	...
	this.mod.defaultView = function(params){
		me.mod.main.open({
			...
			track:[
				{name:'用户管理'},
				{name:'全部用户',handler:me.openAllUserGrid},
				{name:'搜索结果'}
			],
			...
			acts:{
//				track:[
//					{value:'搜索',handler:me.serchUser,exp:'all'},
...
//				],
			...
			store:{
				service :$sl.guserManager_allUsersGrid_seachUserByKey.service,
				method :$sl.guserManager_allUsersGrid_seachUserByKey.method,
				params:{
			...
			colnums:[
					...
					{header:'登录名',textAlign:'left',width:100,mapping:'loginName',handler:me.open,renderer:me.setCur },
					{header:'姓名',textAlign:'left',width:130,mapping:'name',handler:me.open,renderer:me.setCur },
			...
			fields:[
				{
					...
					cols:[
					    ...
					    {xtype:'blank',width:5},
						{xtype:'text',width:'max',itemId:'authrizedId',width:'max'},
