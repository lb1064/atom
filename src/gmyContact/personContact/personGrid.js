...
//		console.log('///option:',option);
		...
		me.mod.main.open({
			id:'groupPersonDetail_GridId'+new Date().getTime(),
			xtype:'grid',
			mode:'loop',
			checkbox:true,
			currentPage:1,
			...
			store:{
				service:$sl.gcontact_personContact_myPersonContact_getChildrenByuuid.service,
				method:$sl.gcontact_personContact_myPersonContact_getChildrenByuuid.method+'$_'+uuid,
				params:{
					uuid:uuid,
					type:'1'
				},
...
//					{name:'查看',value:'查看',imgCls:'preview_btn',handler:me.lookAtPersonDetailInfo},
	//				{name:'编辑',value:'编辑',imgCls:'edit_btn',handler:me.editPerson},
...
//					{name:'合并联系人',value:'合并联系人',handler:me.mergeRelman}
			...
			colnums:[
				...
				{header:'',width:50,textAlign:'left'},
				{header:'电话',width:80,mapping:'phones',renderer:me.renderPhone,textAlign:'left'},
				...
				{header:'',width:50,textAlign:'left'},
				{header:'邮箱',mapping:'intraEmail',width:'max',textAlign:'center',textAlign:'left'},
...
//		record.set('useTitle',false);
	...
	this.quedingAddnewBuildGroup  = function(){
		var pop = me.mod.main.popMgr.get('createNewGroup');
		var btn = pop.getButton("subBtn");
...
//					});
					...
					me.mod.main.getNavigation().initMethod({type:'1',uuid:data.groupUuid});
					btn.setEnabled(true);
				}
			},
			failure:function(){
...
//				]}
				...
				popBtn:[
					{name:'确定',value:'确定',itemId:'subBtn',handler:me.quedingAddnewBuildGroup},
