...
new (function(){
	...
	this.mod.defaultView = function(params){
		...
		me.mod.main.open({
			id:'viewOrg_PersonDetailContactInfoId',
			xtype:'form',
			mode:'loop',
			checkbox:false,
			usePage:false,
			track:track,
				...
				success:function(data,mod){
					var form = me.mod.main.get('viewOrg_PersonDetailContactInfoId');
					var isSystemUerItenid = form.getByItemId('is_OrgSystemUerItenid');
					...
					me.mod.main.historyMgr.reloadTrack(data.path);  
			...
			fields:[
				...
				{height:36,cols:[//165
					...
					{xtype:'blank',width:5},
					{xtype:'label',textAlign:'left',itemId:'is_OrgSystemUerItenid',name:'isSystemUser',value:'',width:'max'},
					{xtype:'blank',width:20}					
				]}
			],
			initMethod:function(mod){
				/*  #
				tspath[tspath.length-2].handler = function(){//路径处理事件
						me.mod.main.goback();
					}
				*/
